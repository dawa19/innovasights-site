  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Customer Success</h2>
            <div className="w-20 h-1 bg-yellow-500 mx-auto"></div>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <ServiceTestimonial
              testimonial="Email security has been dramatically improved since INNOVASIGHTS implemented the gateway solution. Phishing attempts are caught before reaching users, and spam is virtually eliminated."
              author="Mark Stevens"
              role="Chief Information Officer"
              company="Professional Services Firm"
            />
            <ServiceTestimonial
              testimonial="The email threat protection deployed by INNOVASIGHTS has saved us from multiple business email compromise attempts. Their advanced detection capabilities are truly impressive."
              author="Yasmin Ali"
