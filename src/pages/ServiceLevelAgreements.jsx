...
export default function ServiceLevelAgreements() {
  ...
  const benefits = [
    {
      title: "Extend IT Teams",
      description: "Add specialized engineering capabilities to your internal team without full-time hiring costs—we're your partner, not your replacement"
    },
    {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-slate-300 mb-8 leading-relaxed">
                Specialized Tier 2 & Tier 3 support packages designed to extend your internal IT team's capabilities. We provide advanced troubleshooting and escalation support as a value-adding partner, not a replacement—with guaranteed response times.
              </p>
