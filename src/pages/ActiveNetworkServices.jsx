    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <ServiceTestimonial
              testimonial="Our network performance improved dramatically after INNOVASIGHTS redesigned our active infrastructure. Their expertise with Cisco and Aruba solutions was evident throughout the project."
              author="Michael Chen"
              role="CTO"
              company="DATALOG"
            />
            <ServiceTestimonial
              testimonial="The team at INNOVASIGHTS provided exceptional support during our wireless network upgrade. The new system handles our growing user base effortlessly with excellent coverage."
              author="Lisa Anderson"
              role="IT Manager"
              company="Jade Textile Egypt"
            />
          </div>
        </div>
      </section>
