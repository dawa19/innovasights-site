  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Client Experiences</h2>
            <div className="w-20 h-1 bg-yellow-500 mx-auto"></div>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <ServiceTestimonial
              testimonial="Our data center relocation was completed ahead of schedule with zero data loss. INNOVASIGHTS' meticulous planning and execution made what could have been a nightmare into a smooth transition."
              author="Andrew Wilson"
              role="Infrastructure Director"
              company="Enterprise Corporation"
            />
            <ServiceTestimonial
              testimonial="The team at INNOVASIGHTS managed our complex multi-site consolidation project flawlessly. Their expertise and 24/7 support during the migration week was exceptional."
