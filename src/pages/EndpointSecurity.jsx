  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">What Clients Are Saying</h2>
            <div className="w-20 h-1 bg-yellow-500 mx-auto"></div>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <ServiceTestimonial
              testimonial="The endpoint protection solution deployed by INNOVASIGHTS stopped multiple ransomware attempts that our previous solution missed. Their EDR platform gives us the visibility we needed."
              author="James Patterson"
              role="IT Security Lead"
              company="EDARA"
            />
            <ServiceTestimonial
              testimonial="INNOVASIGHTS managed the entire endpoint security rollout across our organization seamlessly. User impact was minimal and protection levels are now best-in-class."
              author="Samira Mahmoud"
              role="Operations Director"
              company="General testimonial"
            />
          </div>
        </div>
      </section>
