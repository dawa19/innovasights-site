          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-slate-300 mb-8 leading-relaxed">
                Building the strong physical foundation for your IT infrastructure with professional structured cabling, connectivity, and physical layouts engineered for high-availability and industry-standard resilience.
              </p>
            ...
            <div>
              <img 
                ...
                alt="Expert Structured Cabling - No Kunafa Standard"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <img 
                ...
                alt="Structured Cabling Management"
