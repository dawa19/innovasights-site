    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <ServiceTestimonial
              testimonial="The storage solution implemented by INNOVASIGHTS has transformed our data management. The tiering strategy they designed optimized our costs while maintaining excellent performance."
              author="David Thompson"
              role="Data Center Manager"
              company="Tamweel Mortgage"
            />
            <ServiceTestimonial
              testimonial="Our backup and recovery capabilities are now enterprise-grade thanks to INNOVASIGHTS. When we had a critical failure, recovery was quick and seamless - exactly as promised."
